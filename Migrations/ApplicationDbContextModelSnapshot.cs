...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PersonalFinanceApp.Models.BalanceHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PersonalFinanceApp.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PersonalFinanceApp.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PersonalFinanceApp.Models.Account", b =>
                {
                    b.HasOne("PersonalFinanceApp.Models.ApplicationUser", "User")
                        .WithMany("Accounts")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
